...
const ApiAccesorioss = () => {
  ...
  const fetchData = async (): Promise<void> => {
    try {
      const response = await fetch('https://ignaciosanchezyuste.es/API_PADEL/accesorios');
      ...
      // ✅ Accede a la propiedad "accesorios"
      if (json && json.accesorios && Array.isArray(json.accesorios)) {
        console.log('Número de accesorios:', json.accesorios.length);
        setData(json.accesorios);
      } else {
